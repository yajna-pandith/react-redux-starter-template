...
class CounterPage extends Component {
  render() {
    ...
    const { decreaseValue, increaseValue, resetValue } = this.props;
      ...
      <React.Fragment>
        <div className="counter-class">
          <div className="counter-class__container">
            ...
            <div
              onClick={resetValue}
              className="counter-class__container--button"
            >
            ...
            <svg
                ...
                height="30.729"
              >
               <path d="M24.078 26.457a2.5 2.5 0 01-1.88 4.267 2.497 2.497 0 01-1.768-.731L5.914 15.362 20.543.732a2.499 2.499 0 113.535 3.536L12.984 15.362l11.094 11.095z" />
              </svg>
              </div>
